...
with open('models/best_model1.pkl', 'rb') as file:
    best_model1 = pickle.load(file)

with open('models/best_model2.pkl', 'rb') as file:
    best_model2 = pickle.load(file)

with open('models/scaler1.pkl', 'rb') as file:
    scaler1 = pickle.load(file)

with open('models/scaler2.pkl', 'rb') as file:
